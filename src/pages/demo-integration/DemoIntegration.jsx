      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Your demo survey has been submitted successfully.</p>
          </div>
          
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-blue-900 mb-2">Submission Summary</h3>
            <div className="space-y-1 text-sm text-blue-800">
              <p><span className="font-medium">Survey:</span> {submittedData.surveyTitle}</p>
              <p><span className="font-medium">Questions:</span> {submittedData.answeredQuestions} of {submittedData.totalQuestions} answered</p>
              <p><span className="font-medium">Submitted:</span> {new Date(submittedData.submittedAt).toLocaleString()}</p>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">SurveyForge Demo Integration</h1>
          <p className="text-lg text-gray-600 mb-6">
            This demo showcases the enhanced SurveyViewer component with configurable submit buttons and enhanced callbacks.
          </p>
          
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Submit Button Variants</h2>
                ...
                <div key={variant} className="text-center">
                  <button
                    className={`px-4 py-2 rounded-md font-medium transition-colors ${
                      ...
                      variant === "outline" ? "bg-transparent border-2 border-blue-600 text-blue-600" :
